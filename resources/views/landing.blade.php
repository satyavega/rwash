...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-primary" href="{{ url('login') }}">@lang('landing.loginOrRegister')</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="bg-blue p-5 text-center">
        <div id="kategoriCarousel" class="carousel slide" data-ride="carousel" data-interval="1500" style="width: 35%; margin: auto;">
            <ol class="carousel-indicators">
                <li data-target="#kategoriCarousel" data-slide-to="0" class="active"></li>
                <li data-target="#kategoriCarousel" data-slide-to="1"></li>
                <li data-target="#kategoriCarousel" data-slide-to="2"></li>
                <li data-target="#kategoriCarousel" data-slide-to="3"></li>
            </ol>
            <div class="carousel-inner text-center">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="{{ asset('img/landing/Baju.jpg') }}" alt="Baju">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Baju</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('img/landing/Celana.jpg') }}" alt="Celana">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Celana</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('img/landing/Jas.jpg') }}" alt="Jas">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Jas</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('img/landing/Selimut.jpg') }}" alt="Selimut">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Selimut</h5>
                    </div>
                </div>
