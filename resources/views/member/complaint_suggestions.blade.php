...
@section('main-content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Kritik Saran atau Testimoni</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <form action="{{ route('member.complaints.store') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" id="tipe" name="type" onchange="checkType(this.value)">
                                                <option value="1">Kritik Saran</option>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5>Riwayat Kritik Saran atau Testimoni</h5>
                            <table class="table">
